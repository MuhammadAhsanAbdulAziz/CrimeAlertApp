...
class AdminComplaintAdapter(private val onComplaintClicked: (ComplaintResponse) -> Unit) :
    ListAdapter<ComplaintResponse, AdminComplaintAdapter.ComplaintViewHolder>(ComparatorDiffUtil()) {
    var counter = 1
